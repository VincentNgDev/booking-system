...
class DataModelValidator {
    ...
    parseRelation(field, accept) {
        var _a, _b, _c, _d, _e;
        const relOneSidedRefAttr = field.attributes.find((attr) => { var _a; return ((_a = attr.decl.ref) === null || _a === void 0 ? void 0 : _a.name) === '@relationOneSideRef'; });
    ...
    validateRelationField(contextModel, field, accept) {
        ...
        if (oppositeFields.length === 0 && (0, sdk_1.hasAttribute)(field, "@relationOneSideRef")) {
            const relOneSidedRefAttr = field.attributes.find((attr) => { var _a; return ((_a = attr.decl.ref) === null || _a === void 0 ? void 0 : _a.name) === '@relationOneSideRef'; });
            const relAttr = field.attributes.find((attr) => { var _a; return ((_a = attr.decl.ref) === null || _a === void 0 ? void 0 : _a.name) === '@relation'; });
            if (relOneSidedRefAttr && relAttr) {
                ...
                if (relationTypeArg && (0, ast_1.isStringLiteral)(relationTypeArg.value) && fieldRefArg) {
                    if (relationTypeArg.value.value.toUpperCase() === 'OneToOne'.toUpperCase()) {
                        const fieldRefs = fieldRefArg.value.items
                            .filter((ref) => (0, ast_1.isDataModelField)(ref.target.ref))
                            .map((ref) => ref.target.$refText);
                        const uniqueFieldNames = contextModel.fields.filter((f) => f.attributes.find((attr) => { var _a; return ((_a = attr.decl.ref) === null || _a === void 0 ? void 0 : _a.name) === '@unique'; })).map((f) => f.name);
